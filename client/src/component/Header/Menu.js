...
function Menu(props) {
    ...
    const [currentUser, setCurrentUser] = context.data.authApi.currentUser
            ...
            <ul className="navbar-nav">
                <li className="nav-item dropdown">
                    ...
                    <ul className="dropdown-menu">
                        ...
                        <li>
                            <NavLink to={'/'} onClick={logoutUser} className="dropdown-item text-while">Logout</NavLink>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <nav className="navbar navbar-expand-md navbar-dark bg-secondary">
                <div className="container">
                    <NavLink to={'/'} className='navbar-brand'>
                        {
                            isLogged ? (
                                <React.Fragment>
                                    {isAdmin ? "Admin-CMS_v1.0" : null}
                                    {isStudent ? "Student-CMS_v1.0" : null}
                                    {isTrainer ? "Trainer-CMS_v1.0" : null}
                                </React.Fragment>
                            ) : "CMS_v1.0"
                        }
                    </NavLink>
                    ...
                    <div className="collapse navbar-collapse" id="menu" >
                        {
                            isLogged ? null : (<ul className="navbar-nav">
