                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <div className="btn-group">
                                                    ...
                                                    <button onClick={() => delHandler(item._id)} className="btn btn-danger"><i className="bi bi-trash"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                    )
                        ...
                        <div className="modal-body">
                            <form autoComplete='off' onSubmit={submitHandler}>
                                <div className="form-group mt-2">
                                    ...
                                    <select value={role} onChange={(e) => setRole(e.target.value)} name="role" id="role" className='form-select'>
